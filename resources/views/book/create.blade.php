...
@section('content')
  <div class="min-h-screen max-w-4xl xl:max-w-6xl mx-auto px-5 pt-24">
    <h1 class="text-3xl mb-6 lg:font-semibold lg:text-4xl">
      <span class="pb-2 border-b-2 border-cyan-600">Create B</span>ook
    </h1>
      ...
      <form action="{{ route('book.store') }}" method="POST">
        ...
        <div class="mb-3">
          <label for="nomor_buku" class="block uppercase tracking-wide text-gray-700 text-sm font-bold mb-1">Nomor
            Buku</label>
          <input type="text" name="nomor_buku" id="nomor_buku" value="{{ $noBook }}"
        ...
        <div class="flex gap-3">
          <button type="submit"
            class="bg-green-600 text-white rounded-xl text-sm font-semibold px-5 py-2.5 transition-all duration-300 hover:bg-green-700">Submit</button>
